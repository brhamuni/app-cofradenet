...
export default async function FeaturedCities() {
  ...
  const allCiudades: Ciudad[] = res.ok ? await res.json() : [];
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 pb-24">
      <div className="flex items-end justify-between mb-12">
        ...
        <Link href="/explorar" className="group flex items-center gap-2 text-sm font-black tracking-widest uppercase text-gray-400 hover:text-cofrade-main transition-colors">

...
export class CreateUsuarioDto {
    ...
    @ApiPropertyOptional({
        description: 'Estilo musical (solo para bandas)',
    ...
    @ApiPropertyOptional({
        description: 'Localidad de la banda',
        example: 'Sevilla',
    })
    @IsString()
    @IsOptional()
    ...
    @ApiPropertyOptional({
        description: 'Nombre del templo de la hermandad',
    ...
    @ApiPropertyOptional({
        description: 'Día de salida procesional',
